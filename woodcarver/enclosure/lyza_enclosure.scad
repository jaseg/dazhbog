...
screw_head_hole_dia = 6; /* FIXME measure this */
...
conn_1_y = 12.5;
conn_1_l = 19.0;
conn_1_h = 5; /* FIXME measure this */
conn_2_y =  conn_1_y+conn_1_l+7.0;
conn_2_l = conn_1_l;
conn_2_h = conn_1_h;
conn_pwr_y = 12.5;
conn_pwr_l = 10.0;
conn_pwr_h = 5; /* FIXME measure this */
conn_extra = 0.5;
module conn_holes() {
    e = conn_extra;
    translate([0, -e, -e])
...
module enclosure() {
    ...
    render() translate([0,0,eps]) mirror([0,0,1]) intersection() {
        ...
        translate([0,0,-0.2]) scale([0.1, 0.1, 0.02]) surface("depthmap_03.png", center=true);
    }
}
